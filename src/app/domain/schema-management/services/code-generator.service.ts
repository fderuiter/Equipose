...
export class CodeGeneratorService {
   ...
   * configuration used to generate the schema. Full algorithmic replication in statistical
   * software requires custom implementation; this export documents the parameters.
   */
  private generateMinimizationHeader(language: 'R' | 'SAS' | 'Python', config: RandomizationConfig): string {
    ...
    const body = [
      ...
      `Full replication in ${language} requires a custom sequential allocation loop.`,
